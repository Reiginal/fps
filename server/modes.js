...
const gungame = {
  ...
  /* **制限時間を持たない。** 2026-08-13に「ガンゲームで時間制限あるの変だし」
     と言われた所。

     時計はラウンドの決着が付かない時に切るための物なので、
     **ラウンドが無いこの遊び方には切る相手が居ない。**
     それでも時計だけが回っていて、3分ごとに「決着なし」でラウンドが終わり、
     幕間を挟んで全員が湧き直していた。段は残るので進行は消えないが、
     撃ち合いの最中に理由の分からない仕切り直しが挟まる。

     決着は「最後の武器で倒したら勝ち」の1本だけでよく、
     誰も勝てないまま終わらない遊び方でもない（倒すたびに必ず進む）*/
  timed: false,
