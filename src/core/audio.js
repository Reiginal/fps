...
export const SWING_TUNES = {
  ...
  katana: {
    light: {
      ...
      gain: 1.38, env: [0.004, 0.105], rate: [1.45, 1.85],
      edge: 0.78,
      air: [330, 700, 250], airGain: 0.26, airDec: 0.13,
    },
    // 唐竹割り。振りかぶりが長いので、音も遅れて伸びる
    heavy: {
      band: [1500, 5200, 2000], at: [0.085, 0.215], q: 3.0,
      gain: 1.55, env: [0.006, 0.175], rate: [1.05, 1.35],
      edge: 0.62,
      air: [250, 600, 220], airGain: 0.62, airDec: 0.24,
    },
  },
  ...
  axe: {
    light: {
      band: [700, 2600, 1100], at: [0.070, 0.190], q: 2.2,
      gain: 1.55, env: [0.008, 0.150], rate: [0.82, 1.02],
      edge: 0.30,
      air: [140, 420, 180], airGain: 0.86, airDec: 0.26,
    },
    heavy: {
      band: [560, 2100, 900], at: [0.086, 0.230], q: 2.0,
      gain: 1.62, env: [0.010, 0.185], rate: [0.68, 0.86],
      edge: 0.26,
      air: [110, 360, 150], airGain: 1.00, airDec: 0.32,
    },
  },

  /* グローブ。**刃の音を持たない。** 布と革と金属が当たる音。
     刃物は「切る」＝高い所が細く伸びるが、拳は「叩く」＝短く止まる。
     帯を中に寄せて、切れの成分(edge)を一番小さくする */
  glove: {
    light: {
      band: [900, 3400, 1400], at: [0.028, 0.062], q: 1.6,
      gain: 1.24, env: [0.004, 0.044], rate: [1.5, 1.8],
      edge: 0.14,
      air: [220, 620, 260], airGain: 0.34, airDec: 0.09,
    },
    heavy: {
      band: [700, 2800, 1150], at: [0.046, 0.104], q: 1.5,
      gain: 1.46, env: [0.006, 0.082], rate: [1.05, 1.30],
      edge: 0.12,
      air: [170, 500, 210], airGain: 0.62, airDec: 0.16,
    },
  },
  ...
  dagger: {
    light: {
      band: [2600, 8200, 3400], at: [0.030, 0.072], q: 3.4,
      gain: 1.26, env: [0.003, 0.046], rate: [1.7, 2.1],
      edge: 0.52,
      air: [360, 800, 300], airGain: 0.16, airDec: 0.07,
    },
    // 突き上げ。払いより低いが、ナイフの強い一撃ほどは重くない
    heavy: {
      band: [1700, 5600, 2200], at: [0.052, 0.120], q: 2.8,
      gain: 1.44, env: [0.005, 0.088], rate: [1.15, 1.45],
      edge: 0.44,
      air: [270, 640, 240], airGain: 0.48, airDec: 0.15,
    },
  },
};
...
export const SHAPE_GUN = {
  ...
  /* クローム（拳銃）。**磨いた金属が鳴る音。**
     ...
     **その2つの間ではなく、外へ出る**必要がある。

     磨いた金属は「硬くて澄んで、少し余韻が残る」ので、
     破裂を上げて胴も上げ、尾は元より少し伸ばす。
     **音程のある層(thump)は持たせない**——あれはサイバーの手なので、
     使うと系統が寄る */
  chrome: {
    volume: 0.68, bodyFreq: 760, crackFreq: 4600,
    bodyDecay: 0.07, tailDecay: 0.44, tailVol: 0.30, crackVol: 0.95,
    thumpFrom: 190, thumpTo: 85, thumpTime: 0.045,
    subVol: 0.07, subTime: 0.07,
  },
